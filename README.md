...
## Experience
- Software Engineer, Systems & Infrastructure @ **Aquaview | USM IAAS** — designed & implemented agent sandbox orchestrator service with concurrent actor-model architecture and OpenTelemetry.
...
## Projects
- **[aether](https://github.com/saphalpdyl/aether)** — A distributed ISP infrastrcuture built almost from scratch with NOS dashboard
- **[deepseek-go](https://github.com/cohesion-org/deepseek-go)** — Go client for Deepseek LLM (⭐ ~300).  
- **[melo spaces](https://github.com/saphalpdyl/melo)** — Interactive 2.5D virtual coworking space with React + WebRTC + Three.js.  
---
